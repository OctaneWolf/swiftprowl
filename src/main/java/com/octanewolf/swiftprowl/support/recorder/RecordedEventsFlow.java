...
package com.octanewolf.swiftprowl.support.recorder;
...
import com.octanewolf.swiftprowl.support.devices.KeyboardLayout;
import com.octanewolf.swiftprowl.support.recorder.actions.*;
...
public class RecordedEventsFlow {
  ...
  public List<IRecordedAction> compile(ProgressMonitor progress) {
    synchronized (this) {
      ...
      List<com.octanewolf.swiftprowl.support.recorder.actions.IRecordedAction> actions = new LinkedList<>();
      modifiers.clear();
