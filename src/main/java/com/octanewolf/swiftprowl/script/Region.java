...
import com.octanewolf.swiftprowl.support.*;
import com.octanewolf.swiftprowl.support.Observer;
import com.octanewolf.swiftprowl.support.devices.HelpDevice;
import com.octanewolf.swiftprowl.support.devices.IRobot;
import com.octanewolf.swiftprowl.support.devices.IScreen;
...
//</editor-fold>
  ...
  private class RepeatableFind extends Repeatable {
    ...
    public <PSI> RepeatableFind(PSI target, Image img) {
      _target = target;
      if (img == null) {
        _image = Element.getImageFromTarget(target);
