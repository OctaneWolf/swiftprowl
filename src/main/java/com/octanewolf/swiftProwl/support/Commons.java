...
import com.octanewolf.swiftProwl.script.*;
import com.octanewolf.swiftProwl.util.CommandArgs;
import com.octanewolf.swiftProwl.util.CommandArgsEnum;
...
import static com.octanewolf.swiftProwl.util.CommandArgsEnum.*;
...
public class Commons {
  ...
  public static void setStartClass(Class startClass) {
    ...
    if (caller.startsWith("com.octanewolf.swiftProwl.ide.Sikulix")) {
...
//      dumpClassPath("sikulix");
  ...
  public static Object runFunctionScriptingSupport(Object reference, String function, Object[] args) {
    ...
    if (reference == null || (reference instanceof String && ((String) reference).contains("org.python"))) {
      try {
        classSup = Class.forName("com.octanewolf.swiftProwl.support.ide.JythonSupport");
      } catch (ClassNotFoundException e) {
      ...
      try {
        classSup = Class.forName("com.octanewolf.swiftProwl.support.ide.JRubySupport");
      } catch (ClassNotFoundException e) {
