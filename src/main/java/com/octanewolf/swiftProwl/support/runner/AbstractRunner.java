...
package com.octanewolf.swiftProwl.support.runner;
...
import com.octanewolf.swiftProwl.script.SikuliXception;
...
//    }
  ...
  @Override
  public final int runScript(String script, String[] scriptArgs, IRunner.Options maybeOptions) {
    IRunner.Options options = null != maybeOptions ? maybeOptions : new IRunner.Options();
  ...
  private boolean consoleChecked = false;

  public boolean consoleChecked() {
    return consoleChecked;
  }

  public void consoleChecked(boolean state) {
    consoleChecked = state;
  }
  ...
  @Override
  public final int evalScript(String script, IRunner.Options maybeOptions) {
    IRunner.Options options = null != maybeOptions ? maybeOptions : new IRunner.Options();
  ...
  @Override
  public final void runLines(String lines, IRunner.Options maybeOptions) {
    IRunner.Options options = null != maybeOptions ? maybeOptions : new IRunner.Options();
  ...
  private int runAbortable(IRunner.Options options, IntSupplier block) {
    boolean newWorker;
  ...
  private int runSynchronized(IRunner.Options options, IntSupplier block) {
    synchronized (AbstractRunner.class) {
      running = true;
