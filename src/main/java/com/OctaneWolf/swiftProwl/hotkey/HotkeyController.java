...
package com.OctaneWolf.swiftProwl.hotkey;
...
import com.OctaneWolf.swiftProwl.script.KeyModifier;
  ...
  private class HotKeyListenerWrapper implements HotKeyListener {
    ...
    public void onHotKey(HotKey hotKey) {
      if (isOldFashion()) {
        ...
        com.OctaneWolf.swiftProwl.basics.HotkeyEvent hotkeyEvent = new com.OctaneWolf.swiftProwl.basics.HotkeyEvent(nkey, nmod);
