 ...
 */
package com.OctaneWolf.swiftProwl.support;

import com.OctaneWolf.swiftProwl.basics.Debug;
import com.OctaneWolf.swiftProwl.basics.PreferencesUser;
import com.OctaneWolf.swiftProwl.basics.Settings;
import com.OctaneWolf.swiftProwl.support.gui.SXDialog;
...
//        _progress.closeAfter(3);
  ...
  private static String doMakeScriptjar(List<String> options, File fSikulixTemp) {
    ...
    if (null != scriptFolderSikuli) {
      ...
      String script = "";
      String prolog = "import com.OctaneWolf.swiftProwl.script.SikulixForJython\n" +
          "from sikuli import *\n" +
          "Debug.on(3)\n" +
          "for e in sys.path:\n" +
          "    print e\n" +
...
//      FileManager.xcopy(fJarRunner, fJarRunnerDir);
      ...
      String manifest = "Manifest-Version: 1.0\nMain-Class: com.OctaneWolf.swiftProwl.support.SikulixRun\n";
      ...
      try {
        cSikulixRun = Class.forName("com.OctaneWolf.swiftProwl.support.support.SikulixRun");
      ...
      if (null == cSikulixRun) {
        log(-1, "makingRunnableScriptJar: problems creating main class com.OctaneWolf.swiftProwl.support.SikulixRun");
        return null;
      }
    }
